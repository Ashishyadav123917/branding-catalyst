...
class AdminTeamEdit extends Component{
    ...
    constructor(props) {
      ...
      componentDidMount() {
        axios.get('http://localhost:5000/admin/portfolio/edit/'+this.props.match.params.id)
         .then(response => {
      ...
      onSubmit(e) {
        ...
        console.log(rgstr);
        axios.post('http://localhost:5000/admin/portfolio/update/'+this.props.match.params.id, rgstr)
    ...
    render(){
        return(
            <Fragment>
                <Helmet pageTitle="Admin Team Edit" />
                                        ...
                                        <form onSubmit={this.onSubmit}>
                                            <label htmlFor="item01">
                                                <input
                                                    ...
                                                    placeholder="Enter Name*"                                                placeholder="Enter Blog Title *"
                                                />
                                            </label>
