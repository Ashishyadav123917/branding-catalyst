...
class AdminTeamEdit extends Component{
    ...
    constructor(props) {
      ...
      componentDidMount() {
        axios.get('http://localhost:5000/admin/team/edit/'+this.props.match.params.id)
         .then(response => {
      ...
      onSubmit(e) {
        ...
        console.log(rgstr);
        axios.post('http://localhost:5000/admin/team/update/'+this.props.match.params.id, rgstr)
