    ...
    <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div className="blog blog-style--1">
                                ...
                                <div className="content">
                                    <p className="blogtype">{props.Blog.Link}</p>
                                    <h4 className="title">{props.Blog.name}</h4>
                                    <div className="blog-btn">
           <a className="rn-btn text-white" href={`/team/edit/${props.Blog._id}`}>Edit</a>
...
class AdminTeamList extends Component{
    ...
    constructor(props) {
      ...
      deleteBlog(id) {
        axios.delete('http://localhost:5000/admin/deleteTeam/'+id)
