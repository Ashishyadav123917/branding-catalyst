...
import { FiCast , FiLayers , FiUsers ,FiChevronUp , FiMonitor, FiCheck } from "react-icons/fi";
...
const Team = props => (
    ...
    <div  key={props.team._id}>
<div className={`team-static`}>
    <div className="thumbnail">
        <img src={props.team.Image} alt="Blog Images"/>
    </div>
    <div className="inner">
        <div className="content">
            <h4 className="title">{props.team.name}</h4>
            <p className="designation">{props.team.Link}</p>
        </div>
...
const Blog = props => (
    ...
    <div className="col-lg-4 col-md-6 col-sm-6 col-12" key={props._id}>
                                    <div className="blog blog-style--1">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="blog-btn">
                                                <a className="rn-btn text-white" href={`/blog-details/${props.Blog._id}`}>Read More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div className="rn-pricing">
        <div className="pricing-table-inner">
            <div className="pricing-header">
                <h4 className="title">{props.pricing.name}</h4>
                <div className="pricing">
                    <span className="price">{props.pricing.price}</span>
                    <span className="subtitle">Rs. Per Month</span>
                </div>
            </div>
            <div className="pricing-body">
                <ul className="list-style--1">
                    <li><FiCheck /> {props.pricing.plan1}</li>
                    <li><FiCheck /> {props.pricing.plan2}</li>
                    <li><FiCheck /> {props.pricing.plan3}</li>
                    <li><FiCheck /> {props.pricing.plan4}</li>
                    <li><FiCheck /> {props.pricing.plan5}</li>
                </ul>
            </div>
...
class CorporateBusiness extends Component{
    ...
    componentDidMount() {
        axios.get('http://localhost:5000/admin/pricing')
         .then(response => {
           this.setState({ pricings: response.data });
      ...
      pricingList() {
        return this.state.pricings.map(currentpricing => {
          return <Pricing pricing={currentpricing} key={currentpricing._id}/>;
        })
      }

      blogList() {
        return this.state.blogs.map(currentpricing => {
          return <Blog Blog={currentpricing} key={currentpricing._id}/>;
        })
      }

      teamList() {
        return this.state.teams.map(currentpricing => {
          return <Team team={currentpricing} key={currentpricing._id}/>;
        })
      }
...
{this.teamList()}
                ...
                {/* Start Brand Area  */}
                <div className="rn-brand-area pb--120 pt--50 bg_color--1">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                ...
                <Link href='https://wa.me/919004629888'>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/1021px-WhatsApp.svg.png" width="60px" style={{ position: 'fixed', bottom: '15px', left: '15px', zIndex: '5' }}></img>
                </Link>
            </Fragment>
        )
    }
